...
Let's say you want to monitor the counts and distribution of response codes logged by a web server.  For the purposes of this example, we'll be sending Nginx response codes to Graphite via StatsD using Logstash.  I'll focus on the Logstash configuration, but if you want to stand up Graphite & StatsD quickly, [check this out]({{< relref "vagrant-graphite-statsd-chef" >}}).
...
{{< gist lanyonm 7697747 logstash.conf >}}
...
<div class="center">
  <figure>
    {{< figure src="/images/nginx-response-codes-graphite.png" link="/images/nginx-response-codes-graphite.png" alt="nginx response codes graphite" >}}
...
<div class="center">
  <figure>
    {{< figure src="/images/kibana-logstash-dashboard.png" link="/images/kibana-logstash-dashboard.png" alt="kibana logstash dashboard" >}}
