...
<div class="center">
  <figure>
    {{< figure src="/images/log4j-json-logstash-kibana-min.png" link="/images/log4j-json-logstash-kibana.png" alt="log4j json logstash kibana min" >}}
...
<div class="center">
  <figure>
    {{< figure src="/images/log4j-tcp-logstash-kibana-min.png" link="/images/log4j-tcp-logstash-kibana.png" alt="log4j tcp logstash kibana min" >}}
...
<div class="center">
  <figure>
    {{< figure src="/images/log4j-raw-logstash-kibana-min.png" link="/images/log4j-raw-logstash-kibana.png" alt="log4j raw logstash kibana min" >}}
