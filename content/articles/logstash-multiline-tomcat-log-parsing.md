...
Additionally, the `multiline filter` used in these examples is not threadsafe. I have [an updated example]({{< relref "log-aggregation-log4j-spring-logstash" >}}#raw-log4j-and-the-multiline-codec) using the multiline codec with the same parsers in the new post.
...
<div class="center">
  <figure>
    {{< figure src="/images/kibana-tomcat-apache-table.png" link="/images/kibana-tomcat-apache-table.png" alt="kibana tomcat apache table" >}}
...
<div class="center">
  <figure>
    {{< figure src="/images/kibana-tomcat-apache-dashboard.png" link="/images/kibana-tomcat-apache-dashboard-lg.png" alt="kibana tomcat apache dashboard" >}}
